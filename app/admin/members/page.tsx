...
import { useMemberStore, type Member, type MemberStatus } from "@/store/member-store";
                  ...
                  <tr key={member.id} className="border-b border-border last:border-b-0 hover:bg-muted/20 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{formatNGN(planPrices[member.plan])}/mo</p>
                      </div>
                    </td>
                    <td className="py-4 px-6">
                      <span
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold">{member.attendanceCount}</span>
...
function MemberModal({
  ...
  const [form, setForm] = useState({
    ...
    attendanceCount: initialData?.attendanceCount || 0,
    profileComplete: initialData?.profileComplete || 0,
  });
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <select
              value={form.plan}
              onChange={(e) => setForm({ ...form, plan: e.target.value as Member["plan"] })}
              className="w-full h-12 rounded-md border border-border bg-background px-4 text-foreground focus:outline-none focus:ring-2 focus:ring-accent"
            >
